...
function AppActivity() {
  const [state] = useState<{
    ...
    series: [
      ...
      { name: "April 8", data: generateData(18, { min: 0, max: 100 }) },
      { name: "April 9", data: generateData(18, { min: 0, max: 100 }) },
    ],
    options: {
      chart: {
        type: "heatmap",
    ...
    vertical: 5 ,
      ...
      ...heatmapConfig, // ✅ Merge external config here
    },
  });
  ...
  return (
    <>
      ...
      {/* ✅ Optional CSS for hiding toolbar via global styles */}
      <style jsx global>{`
        .apexcharts-toolbar {
